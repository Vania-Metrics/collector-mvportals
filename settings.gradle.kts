...
// never a sibling directory. The repo is cloned into .gradle/vania-core and
...
dependencyResolutionManagement {
    ...
    repositories {
        ...
        // and its checksum verification fails writing verification-metadata.xml
        // — or even writes an incomplete file (gradle/gradle#32739, #26803, open).
        // The cost: no transitive dependencies. The "paper" bundle in the catalog
        // declares them.
        exclusiveContent {
            forRepository {
...
val vaniaCoreDir: File = providers.gradleProperty("vaniaCore.dir").orNull?.let { file(it) } ?: run {
    ...
    val refRecorded = file(".gradle/vania-core.ref")
    ...
    } else if (!gradle.startParameter.isOffline || refRecorded.takeIf { it.exists() }?.readText() != ref) {
